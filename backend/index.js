...
//Database Connection With MonggoDb
mongoose.connect("mongodb+srv://nguyennhophuoc:05082003@cluster0.nowxe.mongodb.net/clothingshop");
...
const fetchUser = async (req,res,next)=> {
    ...
    if(!token){
        ...
        try {
            ...
            res.status(401).send({errors:"Please authenticate using valid tokenn"})
        }
    }
}

//Creating endpoind for add product in cartdata
...
//Creating endpoind for remove product from cartdata
...
//Creating endpoind for get cart from cartdata
